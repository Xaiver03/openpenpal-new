      ...
      const mockTasks: CourierTask[] = [
        {
          ...
          priority: 'high',
          reward: 25,
          pickup_address: '北京大学图书馆门口',
          delivery_address: '北京大学宿舍A区101楼',
          created_at: '2024-01-21T08:00:00Z',
          updated_at: '2024-01-21T09:30:00Z',
          description: '重要文件，需要快速投递'
        },
        {
          id: 'task_002',
          ...
          priority: 'normal',
          reward: 15,
          pickup_address: '北京大学教学楼B座',
          delivery_address: '北京大学宿舍B区201楼',
        ...
        },
        {
          id: 'task_003',
          courier_id: '',
          letter_code: 'LTR-20240121-003',
          status: 'pending',
          priority: 'normal',
          reward: 15,
          pickup_address: '北京大学学生会办公室',
          delivery_address: '北京大学宿舍C区305楼',
        ...
        },
        {
          ...
          letter_code: 'LTR-20240121-004',
          status: 'failed',
          priority: 'low',
          reward: 10,
          pickup_address: '北京大学食堂',
          delivery_address: '北京大学宿舍D区401楼',
          created_at: '2024-01-20T15:00:00Z',
          updated_at: '2024-01-20T18:00:00Z',
          description: '投递失败，需重新分配'
        }
      ]
