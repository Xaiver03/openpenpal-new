...
func (c *Client) joinDefaultRooms() {
	...
	// 加入角色房间
	switch c.user.Role {
	case models.RoleCourierLevel1, models.RoleCourierLevel2, models.RoleCourierLevel3, models.RoleCourierLevel4:
		c.JoinRoom(string(RoomCouriers))
	case models.RolePlatformAdmin, models.RoleSuperAdmin:
...
func (c *Client) handleLocationUpdate(message *Message) {
	// 验证用户是否有信使权限
	if !c.user.HasRole(models.RoleCourierLevel1) {
